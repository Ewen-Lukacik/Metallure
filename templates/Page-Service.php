...
$anchor = get_field('anchor_bloc1');
    ...
    //  var_dump($service2_picture);
    //  var_dump($service3_picture);
    //  echo '</pre>';
    //  die(); 
?>
...
<div class="main">
    <div class="wrap">
        <article id="<?php echo($anchor);?>" class="content">
            ...
            <img class="content-img1" src="<?php echo($service1_picture['url']); ?>" 
                height="<?php echo($service1_picture['sizes']['content_picture-height']); ?>" 
                width="<?php echo($service1_picture['sizes']['content_picture-width']); ?>" 
                alt="<?php echo($service1_picture['alt']); ?>">
        </article>

        <article id="service-2" class="content" style="background-color: #1e1e1e;">
            <img class="content-img1" src="<?php echo($service2_picture['url']); ?>" 
                    height="<?php echo($service2_picture['sizes']['content_picture-height']); ?>" 
                    width="<?php echo($service2_picture['sizes']['content_picture-width']); ?>" 
        ...
        <article id="service-3" class="content">
            ...
            <img class="content-img1" src="<?php echo($service3_picture['url']); ?>" 
                height="<?php echo($service3_picture['sizes']['content_picture-height']); ?>" 
                width="<?php echo($service3_picture['sizes']['content_picture-width']); ?>" 
                alt="<?php echo($service3_picture['alt']); ?>">
        </article>
    </div>
