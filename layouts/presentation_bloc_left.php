...
<article id="<?php echo ($anchor); ?>" class="content" style="background-color: #1e1e1e;">
    <div class="wrap content-wrap">
            ...
            src="<?php echo ($content['presentation_bloc2_image1']['url']); ?>" 
            height="<?php echo ($content['presentation_bloc2_image1']['sizes']['realisation_picture-height']); ?>" 
        width="<?php echo ($content['presentation_bloc2_image1']['sizes']['realisation_picture-width']); ?>" 
            alt="<?php echo ($content['presentation_bloc2_image1']['alt']); ?>">
